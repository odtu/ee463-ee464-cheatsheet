...
\begin{figure}
	\includegraphics[scale=0.6]{heat}
\end{figure}

\subsection*{\small Thermal \& Filter }
\begin{itemize}
\item {Convection Thermal Resistance}
\begin{equation*}
R_c=\frac{1}{Ah}
\end{equation*}

\item {Fluid Temperature Rise}
\begin{equation*}
\Delta T=\frac{P}{Q d C_p}
\end{equation*}
...
\textit{Radiation}
\par
\textit{$q_R$ : Radiation heat flow ($W/m^2$)}
\begin{equation*}
q_R=\rho\epsilon F((T_1)^4-(T_2)^4)
\end{equation*}
...
\end{equation*}
\textit{Damping factor:}
\begin{equation*}
\zeta=\frac{L}{2R\sqrt{LC}}
\end{equation*}

\end{itemize}

\begin{figure}
	\includegraphics[scale=0.5]{boostoutput}
\end{figure}

\begin{figure}
	\includegraphics[scale=0.5]{buckoutput}
\end{figure}
